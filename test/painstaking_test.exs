defmodule PainStakingTest do
  ...
  test "simple kelly_size" do
    no_advantage_error = {:error, "This is not an advantage situation."}
    ...
    assert PainStaking.kelly_size(15000, {[prob: "0.50"], [us: -110]})   == no_advantage_error, "Cannot beat the vig with coin-flips"
  end
